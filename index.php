    ...
    <div class="container">
        <div class="row g-0 align-items-center">
                ...
                <div class="inner-column">
                    <div class="content-box">
                        ...
                        <h1 class="title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Empowering
                            <span>Businesses</span> & Trusted Expertise</h1>
                        <p class="text wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">Transforming your
                            accounting experience: Enhancing Efficiency, Driving Cost Savings, Promoting Work-Life
                            Balance, Fostering CSR Excellence
                        </p>
                        <div class="btn-wrp">
                            <a class="btn-two-rounded wow fadeInLeft" data-wow-delay="500ms" data-wow-duration="1500ms"
                                href="page-about.html">Consult Now <i class="fa-regular fa-angle-right"></i></a>
            ...
            <div class="col-lg-5 image-column">
                <figure class="image">
                    <img class="animation__arryLeftRight wow imageDownToUP" src="images/banner/banner-two-image.png"
                        alt="Image">
                ...
                <div class="inner-column">
                    ...
                    <div class="info" data-tilt data-tilt-max="3">
                        ...
                        <div class="users">
                            ...
                            <span>5m+ Customer
                                <svg width="112" height="3" viewBox="0 0 112 3" fill="none"
            ...
            <div class="col-xl-6 content-column">
                <div class="inner-column">
                    ...
                    <div class="info mt-40 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <a class="btn-one-rounded" href="page-contact.html">Know More<i
                                class="fa-regular fa-angle-right"></i></a> <span class="mx-2">|</span>
                        <a class="btn-one-light" href="page-contact.html"><i class="bi bi-telephone mr-3"></i> Call Us
                            Now</a>
...
<section class="funfact-section-two have-after d-none">
    <div class="sec-shape">
        <img class="animation__rotateAndScale" src="images/shape/funface-dual-circle.png" alt="Image">
    </div>
    <div class="container">
        <div class="outer-box">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-xl-4 col-xxl-4">
                    <div class="sec-title">
                        <h6 class="sub-title wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Insights
                        </h6>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="funfact-block-two">
                                <div class="inner-box">
                                    <div class="icon">
                                        <svg width="55" height="60" viewBox="0 0 55 55" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="content-box">
                                        <h3 class="title"><span class="count">150</span>+</h3>
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="funfact-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="content-box">
                                        <h3 class="title"><span class="count">17</span>k+</h3>
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="funfact-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="content-box">
                                        <h3 class="title"><span class="count">15</span>+</h3>
                                        <span class="sub-title">Winning award</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="outer-box">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="service-box">
                        ...
                        <div class="click-btn-wrp">
                            <a class="click-btn" href="page-case-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                          </div>
                        </div>
                    </div>
                    <div class="description-box">
                        <h6>Comprehensive Bookkeeping</h6>
                        <p>We ensure accurate, organized, and up to date financial records forming the backbone of your
                            business’s financial health and supporting better decision-making.
                        </p>
                        <a href="#" class="mt-2">CONNECT NOW</a>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="description-box">
                        ...
                        <p>We handle your VAT filings efficiently, ensuring compliance, timely submissions, and maximum
                ...
                <div class="col-md-4 mt-4">
                    ...
                    <div class="description-box">
                        ...
                        <p>Through strategic planning, we help minimize corporate tax liabilities, maximize returns, and
                ...
                <div class="col-md-4 mt-4">
                    ...
                    <div class="description-box">
                        ...
                        <p>From filing to optimization, we manage your personal taxes with precision, ensuring you meet
            ...
            <div class="processing-section bg-none section-process">
                <h5 class="sec-text mt-50 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">Embrace
                    Innovation, Adapt Quickly, and Lead with Confidence. <a href="services.php">View More </a></h5>
            </div>
        </div>
    </div>
</section>
          ...
          <div class="inner-column">
            ...
            <div class="choose-tab">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true"> Expertise</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false"> Innovation</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false"> Commitment</button>
                </li>
              </ul>
            </div>
            ...
            <div class="tab-content mt-30" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="content-box">
                  <p class="text"> Our skilled professionals bring years of experience and precision, delivering accurate, reliable, and high-quality financial solutions for every client.</p>
                  ...
                  <a href="javascript:void(0);" class="btn-two">Discover More</a>
                </div>
              </div>

              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="content-box">
                  <p class="text"> We leverage smart technology and automation to simplify processes, improve efficiency, and help businesses make faster, data-driven decisions effortlessly.</p>
                  <div class="list mt-30 mb-50">
                    <ul>
                      <li>
              ...
              <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                <div class="content-box">
                  <p class="text"> With a client-first mindset, we ensure transparency, timely support, and consistent performance to build lasting trust and measurable growth.</p>
                  <div class="list mt-30 mb-50">
                    <ul>
                      <li>
    ...
    <div class="container">
      <div class="sec-title pb-50 mb-50">
        ...
        <div class="flex-content">
          <h2 class="title text-white wow splt-txt" data-splitting>Creating Financial <br>Partnerships for Unlimited <br>Growth.</h2>
  ...
  <!-- Growth area end here -->
    ...
    <section class="processing-section pt-120">
        ...
        <div class="container">
              ...
              <div class="col-sm-6 col-xl-3 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                <div class="processing-block">
                  <div class="inner-box">
                    ...
                    <p class="text">We begin by analyzing your business goals and financial requirements to craft a tailored strategy.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-xl-3 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="processing-block">
                  <div class="inner-box">
                    ...
                    <p class="text">Our experts design a structured plan integrating accounting precision with innovative digital solutions.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-xl-3 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="processing-block">
                  <div class="inner-box">
                    ...
                    <p class="text">We implement the plan seamlessly, monitor progress, and refine processes for maximum efficiency.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-xl-3 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div class="processing-block">
                  <div class="inner-box last-block">
                    ...
                    <p class="text">We regularly review performance, provide insights, and support your business for sustainable growth.</p>
                  </div>
                </div>
              </div>
          ...
          <h5 class="sec-text mt-50 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">Embrace Innovation, Adapt Quickly, and Lead with Confidence. <a href="javascript:void(0);">Consult Now</a></h5>
        </div>
      </section>
      <!-- Processing area end here -->

<!-- Growth area start here -->
<section class="growth-section pt-120 pb-120 d-none" data-background="images/bg/growth-bg.jpg">
    <div class="sec-shape">
      <img class="sway_Y__animation" src="images/shape/growth-shape.png" alt="Image">
    </div>
    <div class="container">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="tab2-tab" data-bs-toggle="tab" data-bs-target="#tab2" type="button"
              role="tab" aria-controls="tab2" aria-selected="false">Yearly</button>
          </li>
        </ul>
      </div>
              ...
              <div class="pricing-block">
                ...
                <div class="inner-box">
                  ...
                  <div class="text-center mt-40">
                    <a class="btn-one-rounded" href="page-pricing.html">$2500/ Month</a>
                  </div>
                </div>
            ...
            <div class="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div class="pricing-block active">
                ...
                <div class="inner-box">
                  ...
                  <div class="text-center mt-40">
                    <a class="btn-one-rounded" href="page-pricing.html">choose pricing plan</a>
                  </div>
                </div>
            ...
            <div class="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
              <div class="pricing-block">
                ...
                <div class="inner-box">
                  ...
                  <div class="text-center mt-40">
                    <a class="btn-one-rounded" href="page-pricing.html">$3500/ Month</a>
                  </div>
                </div>
