      ...
      <div class="header-top">
        <div class="auto-container">
          ...
          <div class="top-left">
            <!-- Info List -->
            <ul class="info-list">
              <li><i class="fa-solid fa-envelope text-white"></i> <a href="">info@cloudwisekpo.com</a>
              </li>
              <li><i class="fa-solid fa-location-dot text-white"></i> 6391 Elgin St. Celina, Delaware 10299</li>
            </ul>
          </div>
